...
function deleteConfirmed(event,id, controller) {
	event.preventDefault();
	var result = confirm("Want to delete?");
	if (result) {
		window.location.href = '../../' + controller + '/DeleteConfirmed/' + id;
	}
	
}

function decison(event, id, controller, view) {
	event.preventDefault();
	var result = confirm("Want to " + view + "?");
	if (result) {
		window.location.href = '../../' + controller + '/' + view + '/' + id;
	}
