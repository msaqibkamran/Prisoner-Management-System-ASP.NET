...
{
    public class jailOfficerAuthentication : AuthorizeAttribute
    {
        ...
        protected override bool AuthorizeCore(System.Web.HttpContextBase httpContext)
        {
            ...
            httpContext.Session["noaccess"] = "You dont have access to this page, try logging in from Jail Officer Credentials";
