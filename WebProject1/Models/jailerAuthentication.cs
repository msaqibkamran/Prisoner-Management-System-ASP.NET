...
{
    public class jailerAuthentication : AuthorizeAttribute
    {
        ...
        protected override bool AuthorizeCore(System.Web.HttpContextBase httpContext)
        {
            ...
            httpContext.Session["noaccess"] = "You dont have access to this page, try logging in from Jailer Credentials";
